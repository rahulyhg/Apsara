...
public class ProductAdapter extends CommonRecyclerAdapter<Product> {
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView tv_subcat_title, tv_subcat_price, tv_subcat_content, tv_subcat_discount_price, tv_discount, tv_out_of_stock, call_us;
        public ImageView iv_subcat, iv_subcat_plus, iv_subcat_minus, iv_subcat_remove, image_spinner,share;
        ...
        public ProductViewHolder(View view) {
            ...
            image_spinner = view.findViewById(R.id.image_spinner);
        ...
        public void onClick(View view) {
            ...
            switch (id) {
                ...
                case R.id.call_us:
                    Intent in = new Intent(Intent.ACTION_CALL, Uri.parse("tel:8121300005"));
        ...
        private void bindData(int position) {
            ...
            spinner_subcat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (stock.getDiscount_percentage().equals("0")) {
                        iv_subcat_plus.setOnClickListener(null);
                        iv_subcat_minus.setOnClickListener(null);
                        tv_discount.setVisibility(View.GONE);
                        tv_subcat_content.setVisibility(View.GONE);
                        spinner_subcat.setVisibility(View.GONE);
